...
class TestBulkUpdateTransactionsObject(unittest.TestCase):
    """BulkUpdateTransactionsObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkUpdateTransactionsObject:
        """Test BulkUpdateTransactionsObject
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `BulkUpdateTransactionsObject`
        """
        model = BulkUpdateTransactionsObject()
        if include_optional:
            return BulkUpdateTransactionsObject(
    ...
    def testBulkUpdateTransactionsObject(self):
        """Test BulkUpdateTransactionsObject"""
