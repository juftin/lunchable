...
class TestCreateNewTransactions201Response(unittest.TestCase):
    """CreateNewTransactions201Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateNewTransactions201Response:
        """Test CreateNewTransactions201Response
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CreateNewTransactions201Response`
        """
        model = CreateNewTransactions201Response()
        if include_optional:
            return CreateNewTransactions201Response(
                transactions = [
                ...
                skipped_existing_external_ids = [
                    lunchable.models.skipped_existing_external_id_object.skippedExistingExternalIdObject(
                        request_transaction_index = 1.337,
                        external_id = '',
                        manual_account_id = 1.337,
                        existing_transaction_id = 1.337, )
                    ]
            )
        else:
            return CreateNewTransactions201Response(
    ...
    def testCreateNewTransactions201Response(self):
        """Test CreateNewTransactions201Response"""
