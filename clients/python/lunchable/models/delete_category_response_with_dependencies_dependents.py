...
class DeleteCategoryResponseWithDependenciesDependents(BaseModel):
    ...
    """ # noqa: E501
    budget: Union[StrictFloat, StrictInt] = Field(description="The number of budgets depending on the category")
    category_rules: Union[StrictFloat, StrictInt] = Field(description="The number of category rules depending on the category")
    transactions: Union[StrictFloat, StrictInt] = Field(description="The number of transactions depending on the category")
    children: Union[StrictFloat, StrictInt] = Field(description="The number of child categories in the category group")
    recurring: Union[StrictFloat, StrictInt] = Field(description="The number of recurring transactions depending on the category")
    plaid_cats: Union[StrictFloat, StrictInt] = Field(description="The number of auto created categories based on Plaid categories")
