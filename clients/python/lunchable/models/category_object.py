...
class CategoryObject(BaseModel):
    ...
    is_income: StrictBool = Field(description="If true, the transactions in this category will be treated as income.")
    exclude_from_budget: StrictBool = Field(description="If true, the transactions in this category will be excluded from the budget.")
    exclude_from_totals: StrictBool = Field(description="If true, the transactions in this category will be excluded from totals.")
    ...
    is_group: StrictBool = Field(description="If true, the category is a group that can be a parent to other categories.")
