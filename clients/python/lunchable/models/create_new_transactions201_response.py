...
class CreateNewTransactions201Response(BaseModel):
    ...
    skipped_existing_external_ids: Optional[List[SkippedExistingExternalIdObject]] = (
        None
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.skipped_existing_external_ids:
            for (
                _item_skipped_existing_external_ids
            ) in self.skipped_existing_external_ids:
        ...
        _obj = cls.model_validate(
            {
                ...
                "skipped_existing_external_ids": [
                    ...
                    for _item in obj["skipped_existing_external_ids"]
                ]
                if obj.get("skipped_existing_external_ids") is not None
                else None,
            }
        )
        return _obj
