...
class PlaidAccountObject(BaseModel):
    ...
    type: StrictStr = Field(description="Primary type of the account, for example credit, depository, etc. This field is set by Plaid and cannot be altered.")
    ...
    status: StrictStr = Field(description="Denotes the current status of the account within Lunch Money. Must be one of<br> - `active`: Account is active and in good state<br> - `inactive`: Account marked inactive from user. No transactions fetched or balance update for this account.<br> - `relink`: Account needs to be relinked with Plaid.<br> - `syncing`: Account is awaiting first import of transactions. <br> - `not found`: Account cannot be found with Plaid<br> - `not supported`: Account is not supported with Plaid<br> - `error`: Account is in error with Plaid.<br>")
    allow_transaction_modifications: StrictBool = Field(description="Is false if the \"Allow Modification To Transactions\" property for this account has been toggled off.  Otherwise it is set to true.")
    ...
    balance_last_update: datetime = Field(description="Date balance was last updated in ISO 8601 extended format. This field is set by Plaid and cannot be altered.")
    ...
    plaid_last_successful_update: datetime = Field(description="Timestamp in ISO 8601 extended format of the last time Plaid successfully connected with institution for new transaction updates, regardless of whether any new data was available in the update.")
    __properties: ClassVar[List[str]] = ["id", "date_linked", "name", "display_name", "type", "subtype", "mask", "institution_name", "status", "allow_transaction_modifications", "limit", "balance", "currency", "balance_last_update", "import_start_date", "last_import", "last_fetch", "plaid_last_successful_update"]
