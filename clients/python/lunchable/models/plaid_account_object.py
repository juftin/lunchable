...
class PlaidAccountObject(BaseModel):
    ...
    balance_last_update: Optional[datetime] = Field(
    ...
    plaid_last_successful_update: Optional[datetime] = Field(
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if (
            self.balance_last_update is None
            and "balance_last_update" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.plaid_last_successful_update is None
            and "plaid_last_successful_update" in self.model_fields_set
        ):
