...
class RecurringObjectTransactionCriteria(BaseModel):
    ...
    payee: Optional[StrictStr] = Field(default=None, description="If any, represents the original transaction payee name that triggered this recurring item's creation.")
    ...
    to_base: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The base amount of the recurring item.")
    ...
    __properties: ClassVar[List[str]] = ["start_date", "end_date", "granularity", "quantity", "anchor_date", "payee", "amount", "currency", "to_base", "plaid_account_id", "manual_account_id"]
