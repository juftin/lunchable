...
class SplitTransactionRequest(BaseModel):
    ...
    """ # noqa: E501
    child_transactions: List[SplitTransactionObject] = Field(description="List of child transactions to create. The sum of the `amounts` must match the split transaction amount.")
