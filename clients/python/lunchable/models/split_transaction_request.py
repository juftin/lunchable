...
class SplitTransactionRequest(BaseModel):
    ...
    child_transactions: Annotated[
        List[SplitTransactionObject], Field(min_length=2, max_length=500)
    ] = Field(
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "child_transactions": [
                    SplitTransactionObject.from_dict(_item)
                    for _item in obj["child_transactions"]
                ]
                if obj.get("child_transactions") is not None
                else None
            }
        )
        return _obj
