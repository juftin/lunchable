...
class CreateNewTransactionsRequest(BaseModel):
    ...
    """ # noqa: E501
    transactions: List[InsertTransactionObject] = Field(description="List of transactions to insert.")
    apply_rules: Optional[StrictBool] = Field(default=False, description="If set to true, any rules associated with the account specified by the `manual_account_id` property for each transaction will be applied.")
    ...
    skip_balance_update: Optional[StrictBool] = Field(default=False, description="If set to true, and new transactions include a `manual_account_id`, the balances of these accounts will not be updated, when the transactions are inserted.")
