...
class DeleteTagResponseWithDependenciesDependents(BaseModel):
    ...
    """ # noqa: E501
    tag_rules: Union[StrictFloat, StrictInt] = Field(description="The number of rules depending on the tag")
    transactions: Union[StrictFloat, StrictInt] = Field(description="The number of transactions with the tag")
    __properties: ClassVar[List[str]] = ["tag_rules", "transactions"]
