...
conf = lunchable.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://lm-v2-api-mock-data-f24357049a1b.herokuapp.com/v2" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("lunchable")
    ...
    def get_host_settings(self) -> List[HostSetting]:
        ...
        return [
            ...
            },
            {
                ...
                'description': "v2 via v1 API Lunch Money API Server",
            }
        ]
