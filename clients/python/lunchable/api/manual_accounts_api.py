...
class ManualAccountsApi:
    ...
    def delete_manual_account(
        self,
        id: Annotated[
            StrictInt, Field(description="ID of the manual account to delete")
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def get_manual_account_by_id(
        self,
        id: Annotated[
            StrictInt, Field(description="ID of the manual account to retrieve")
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def update_manual_account(
        self,
        id: Annotated[
            StrictInt, Field(description="ID of the manual account to update")
        ],
