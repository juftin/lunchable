...
class PlaidAccountsApi:
    ...
    def trigger_plaid_account_fetch(
        ...
        plaid_account_id: Annotated[Optional[StrictInt], Field(description="Specific ID of a plaid account to fetch. If not set the endpoint will trigger a fetch for all eligible accounts.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
