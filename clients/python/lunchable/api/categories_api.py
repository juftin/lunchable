...
class CategoriesApi:
    ...
    def get_all_categories(
        ...
        is_group: Annotated[Optional[StrictBool], Field(description="If set to `false`, just the list of assignable categories is returned.<br> If set to `true`, only category groups are returned.<br> When set the `format` parameter is ignored.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
