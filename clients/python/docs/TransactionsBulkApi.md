...
| **include_pending**       | **bool** | Set to true if you&#39;d like to include imported transactions with a pending status. This query param is ignored if the &#x60;status&#x60; query param is also set.                                                                                                                                                                                                                                                                                                                                                                                                | [optional] [default to False] |
