...
*RecurringApi* | [**get_all_recurring**](docs/RecurringApi.md#get_all_recurring) | **GET** /recurring | Get a all recurring items
*RecurringApi* | [**get_recurring_by_id**](docs/RecurringApi.md#get_recurring_by_id) | **GET** /recurring/{id} | Get a single recurring item
